/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: be040477b1acddc116ac7d873e861d86)
// Runtime types generated with workerd@1.20260721.1 2026-07-22 
interface __BaseEnv_Env {
	BEER_PHOTOS: R2Bucket;
	UPLOAD_RATE_LIMITER: RateLimit;
	AI: Ai;
	PHOTO_RESULTS: DurableObjectNamespace<import("./src/index").PhotoResults>;
	MAP_SUBMISSIONS: DurableObjectNamespace<import("./src/index").MapSubmissions>;
	PHOTO_WORKFLOW: Workflow<Parameters<import("./src/index").PhotoAssessmentWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PhotoResults" | "MapSubmissions";
	}
